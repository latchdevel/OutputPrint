/*
 ...
 Modified by Jorge Rivera Feb 2021:
  ...
  - Add includes for BitsAndBytes.h, WCharacter.h and WString.h
  - Remove unused WMath.h
  - Suprime all class __FlashStringHelper references
 */
...
size_t Print::printNumber(unsigned long n, int base) {
  ...
  *str = '\0';
  ...
  do {
    ...
    char c = (char)(m - (unsigned long)base * n);
