/*
  ...
  Modified by Jorge Rivera Feb 2021:
    - Suprime AVR #include <avr/pgmspace.h>
	- Suprime class __FlashStringHelper;
    - Suprime  #define F(string_literal) (reinterpret_cast<const __FlashStringHelper *>(PSTR(string_literal)))
